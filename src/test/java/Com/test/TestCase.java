...
public class TestCase {
	...
	public void verifyStateRequriedOrNot() {
		...
		keyword.click(prop.getLocatorValue("LOGIN"));
		// keyword.sendKeys(prop.getLocatorValue( "NAME"), "Ajit");
		keyword.sendKeys(prop.getLocatorValue("NAME"), "ajit");
		...
		// keyword.sendKeys(prop.getLocatorVaplue(filepath, "ZIPCODE"), "Ajit");
...
@Test
	public void verifyMobilenumberInvalidOrNot() {
		Keyword keyword = new Keyword();
		keyword.openBrowser();
		keyword.OpenUrl(Locators.CAPPURL);
		keyword.click(Locators.ENGLISH);
	}
